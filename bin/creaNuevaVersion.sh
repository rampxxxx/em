...
WRAPPER_BIN_MACOSX_32=wrapper_25353_i686-apple-darwin
WRAPPER_BIN_MACOSX_64=wrapper_25353_x86_64-apple-darwin
...
if [[ "$NOMBRE_PLATAFORMA" == *i686-pc-linux-gnu* ]]
then
	...
	if [[ "$NOMBRE_PLATAFORMA" == *windows_intelx86* ]]
	then
		...
		if [[ "$NOMBRE_PLATAFORMA" == *i686-apple-darwin* ]]
		then
